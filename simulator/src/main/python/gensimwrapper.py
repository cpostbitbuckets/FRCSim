...
# for vendor versions
# ./gensimwrapper.py replace-native-methods -src-file ../../../../simulator-rev/src/main/java/frc/robot/simulator/hal/rev/SimCANSparkMaxJNI.java -sim-name SimCANSparkMax -print
# generate the Sim* static class
# ./gensimwrapper.py gen-sim-class -src-file ../../../../simulator-rev/src/main/java/frc/robot/simulator/hal/rev/SimCANSparkMaxJNI.java -sim-name SimCANSparkMax -print
